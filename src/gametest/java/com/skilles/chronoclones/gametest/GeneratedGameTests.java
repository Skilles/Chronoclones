...
public class GeneratedGameTests {
    ...
    @GameTest(template = "chronoclones:test_plot", timeoutTicks = 200)
    ...
    @GameTest(template = "chronoclones:test_plot", timeoutTicks = 240)
    ...
    @GameTest(template = "chronoclones:test_plot", timeoutTicks = 400)
